...
namespace DataProvInventario.InfraEstructura
{
    ...
    public interface IProducto
    {
        ...
        OOB.ResultadoLista<OOB.LibInventario.Producto.Data.Ficha> 
        ...
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Data.Identificacion>
            Producto_GetIdentificacion (string autoPrd);
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Data.Existencia> 
            Producto_GetExistencia(string autoPrd);
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Data.Precio> 
            Producto_GetPrecio(string autoPrd);
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Data.Costo> 
            Producto_GetCosto(string autoPrd);
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Data.Imagen> 
            Producto_GetImagen(string autoPrd);
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Data.Proveedor.Ficha> 
            Producto_GetProveedores(string autoPrd);

        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Depositos.Lista.Ficha> 
        ...
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Depositos.Ver.Ficha> 
        ...
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Editar.Obtener.Ficha> 
        ...
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Estatus.Actual.Ficha> 
        ...
        OOB.ResultadoEntidad<OOB.LibInventario.Producto.Precio.Ficha>
