...
namespace ModInventario.Helpers
{
    public static class HndReportes
    {
        ...
        //    filtro.setDesde(DateTime.Now.Date);
        //    filtro.setHasta(DateTime.Now.Date);
        //    filtro.setGestion(new Reportes.Filtros.Kardex.FiltrosModoSucursal());
        //    filtro.Inicia();
        //    if (filtro.FiltrosIsOK)
        //    {
        //        if (filtro.dataFiltrar.Producto == null)
        ...
        //    filtro.Inicializa();
        //    filtro.setValidarData(false);
        //    filtro.setGestion(new Reportes.Filtros.NivelMInimo.FiltrosModoSucursal());
        //    filtro.Inicia();
        //    if (filtro.FiltrosIsOK)
        //    {
        ...
        //    filtro.Inicializa();
        //    filtro.setValidarData(false);
        //    filtro.setGestion(new Reportes.Filtros.MaestroExistenciaInventario.FiltrosModoSucursal());
        //    filtro.Inicia();
        //    if (filtro.FiltrosIsOK)
        //    {
