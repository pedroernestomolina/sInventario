...
namespace ModInventario.MovimientoInvTipo.Ajuste.Captura
{
    ...
    public partial class EntradaFrm : Form
    {
        ...
        private ICapturaMovAjuste _controlador;
        ...
        private void EntradaFrm_Load(object sender, EventArgs e)
        {
            ...
            CB_TIPO_MOV.DataSource = _controlador.TipoMovSource;
            CB_EMPAQUE.DataSource = _controlador.EmpaqueSource;
            CB_EMPAQUE.SelectedValue = _controlador.EmpaqueGetID;
            CB_TIPO_MOV.SelectedValue= _controlador.TipoMovGetID;
        ...
        public void setControlador(ICapturaMovAjuste ctr)
        {
            _controlador = ctr;
        }
