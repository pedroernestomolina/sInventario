...
namespace ModInventario.MovimientoInvTipo.AjusteInvCero
{
    public partial class MovFrm : Form
    {
        ...
        {
            CapturarDataAplicarAjusteInvCero();
        }
        private void CapturarDataAplicarAjusteInvCero()
        {
            _controlador.CapturarDataAplicarAjusteInvCero();
            if (_controlador.CapturarDataAplicarAjusteInvCeroIsOk)
            {
                ActualizarImporte();
            }
        }
