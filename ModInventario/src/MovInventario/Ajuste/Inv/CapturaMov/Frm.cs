...
namespace ModInventario.src.MovInventario.Ajuste.Inv.CapturaMov
{
    ...
    {
        private ICapturaMov _controlador;
        ...
        public void setControlador(ICapturaMov ctr)
        {
            _controlador = ctr;
        }
        ...
        private void EntradaFrm_Load(object sender, EventArgs e)
        {
            ...
            CB_TIPO_MOV.DataSource = _controlador.Captura.TipMov.GetSource;
            CB_TIPO_MOV.SelectedValue = _controlador.Captura.TipMov.GetId;
        ...
        private void CB_TIPO_MOV_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            _controlador.Captura.setTipoMov("");
            if (CB_TIPO_MOV.SelectedIndex != -1)
            {
                _controlador.Captura.setTipoMov(CB_TIPO_MOV.SelectedValue.ToString());
            }
            ActualizarData();
        }
