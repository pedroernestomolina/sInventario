...
{
    public class ImpCapturaMov: ICapturaMov
    {
        ...
        private bool CargarData()
        {
            ...
            if (_modoEditar)
            {
                ...
                _dataMov.setTipoMov(_itEditar.TipMov.GetId);
            }
            return true;
        }
    }
