...
namespace ModInventario.src.MovInventario.Tools.ListaMov
{
    public class data
    {
        ...
        //
        public string InfProductoDesc { get { return codigoPrd + Environment.NewLine + nombrePrd; } }
        public string InfProductoEmpaCompra { get { return nombreEmp + "(" + contEmp.ToString() + ")"; } }
        public string InfProductoEsAdmDivisa { get { return esAdmDivisa ? "SI" : "NO"; } }
