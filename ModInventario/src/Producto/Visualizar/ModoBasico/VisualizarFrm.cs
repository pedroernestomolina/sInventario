...
namespace ModInventario.src.Producto.Visualizar.ModoBasico
{
    ...
    public partial class VisualizarFrm : Form
    {
        ...
        private ModInventario.Producto.VisualizarFicha.IVisualizar _controlador;
        ...
        public void setControlador(ModInventario.Producto.VisualizarFicha.IVisualizar ctr)
        {
            _controlador = ctr;
        }
