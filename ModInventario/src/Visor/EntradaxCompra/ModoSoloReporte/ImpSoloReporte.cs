...
namespace ModInventario.src.Visor.EntradaxCompra.ModoSoloReporte
{
    ...
    public class ImpSoloReporte: ISoloReporte
    {
        ...
        public void Buscar()
        {
            ...
            {
                _lista.Clear();
                var filtro = new OOB.LibInventario.Visor.EntradaxCompra.Filtro()
                {
                    idDeposito = Sistema.Negocio.CodigoDepositoPrincipal,
                    ano = int.Parse(_gAno.GetId),
                    mes = int.Parse(_gMes.GetId),
                };
                var r01 = Sistema.MyData.Visor_EntradaxCompra(filtro);
