...
namespace ModInventario.src.Visor.GananciaPerdida.ModoSoloReporte
{
    
    public class ImpVisorGanPerd: IVisorGanPerd
    {
        ...
        public decimal GetTotal
        {
            get
            {
                ...
                if (_lista != null)
                    if (_lista.Count > 0)
                        rt = _lista.Sum(s => s.Monto* s.Signo);
                return rt;
            } 
        }
        public decimal GetTasa
        {
            get 
            {
                var rt = 0.0m;
                if (ventasNeta>0)
                    rt = GetTotal / ventasNeta * 100;
                return rt;
            }
        }


        public ImpVisorGanPerd()
        {
        ...
        public void Buscar()
        {
            ...
            try
            {
                ...
                foreach (var rg in r01.Entidad.detalles.
                    Where(w=>w.autoDepositoOrigen==Sistema.Negocio.CodigoDepositoPrincipal).
                    OrderBy(o => o.fecha).ThenBy(o => o.documentoNro).
                    ThenBy(o => o.nombrePrd).
                    ToList())
                {
